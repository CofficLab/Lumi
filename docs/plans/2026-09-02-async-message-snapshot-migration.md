...
The bounded pagination API is covered by the follow-up commit `b9942517c`; refresh-source deduplication and direct insertion-event application were completed in the subsequent message-list work. The V1/brief window migration is tracked in [`2026-09-02-v1-window-pagination.md`](2026-09-02-v1-window-pagination.md).
