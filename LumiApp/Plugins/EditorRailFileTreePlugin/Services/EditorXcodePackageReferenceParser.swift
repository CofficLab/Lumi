...
struct EditorXcodePackageReference: Equatable, Sendable {
    let id: String
...
enum EditorXcodePackageReferenceParser {
    static func parse(projectURL: URL) throws -> [EditorXcodePackageReference] {
    ...
    static func parse(contents: String) -> [EditorXcodePackageReference] {
