...
actor QuickFileSearchPlugin: SuperPlugin, SuperLog {
    ...
    nonisolated static let enable: Bool = true    nonisolated static let verbose = false  // 关闭调试日志
    ...
    nonisolated static let isConfigurable: Bool = false    static var order: Int { 50 }
