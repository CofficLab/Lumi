...
@MainActor
final class JSTaskManager: ObservableObject, SuperLog {
    ...
    func run(script: String, projectPath: String, arguments: [String] = [], mode: TaskState = .running) async {
        state = mode
    ...
    func build(projectPath: String, package: JSPackageInfo?) async {
    ...
    func test(projectPath: String, package: JSPackageInfo?) async {
    ...
    func lint(fileURL: URL?, projectPath: String) async {
        state = .linting
    ...
    func format(fileURL: URL?, projectPath: String?) async {
        state = .formatting
