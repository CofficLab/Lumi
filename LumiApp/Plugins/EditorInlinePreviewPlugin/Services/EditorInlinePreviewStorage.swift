...
/// EditorInlinePreview 插件专属存储根目录与相关预览构建路径。
///
/// 存储位置：`AppConfig.getPluginDBFolderURL(pluginName: "EditorInlinePreviewPlugin")/`
enum EditorInlinePreviewStorage {
    ...
    static let pluginName = "EditorInlinePreviewPlugin"
