...
@MainActor
final class GoTestGutterContributor: SuperEditorGutterDecorationContributor {
    let id = "go.test-gutter"
    ...
    static func testLineNumbers(in content: String, range: Range<Int>) -> [Int] {
