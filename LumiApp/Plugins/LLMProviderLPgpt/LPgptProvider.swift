...
/// LPgpt API 供应商实现
///
/// LPgpt (lpgpt.us) 完全兼容 OpenAI 格式
/// 使用 LLMProviderKit 的 OpenAICompatibleProviderAdapter 处理请求构建和响应解析。
final class LPgptProvider: NSObject, SuperLLMProvider, @unchecked Sendable {
    ...
    static let id = "lpgpt"
    static let displayName = String(localized: "LPgpt", table: "LPgpt")
    static let shortName = "LP"
    static let description = String(localized: "Free LLM Gateway by lpgpt.us", table: "LPgpt")

    static let websiteURL: String? = "https://lpgpt.us"

    // MARK: - 配置相关

    static let apiKeyStorageKey = "DevAssistant_ApiKey_LPgpt"
