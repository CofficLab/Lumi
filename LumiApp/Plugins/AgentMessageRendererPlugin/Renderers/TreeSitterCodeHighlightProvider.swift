...
final class TreeSitterCodeHighlightProvider: CodeHighlightProviding, @unchecked Sendable {
...
extension EditorTheme {
    /// 将 CaptureName 映射到颜色
    func colorForCapture(_ capture: CaptureName) -> NSColor {
        switch capture {
