...
@MainActor
final class EmbeddedCSSService {
    /// 单例
    static let shared = EmbeddedCSSService()
    ...
    /// 检查给定坐标是否在 CSS 区域内
    func isInCSSRegion(line: Int, character: Int, sourceLines: [String]) -> Bool {
    ...
    /// 将补全坐标转换为虚拟文档坐标
    func toVirtualCoordinates(line: Int, character: Int, sourceLines: [String]) -> (line: Int, character: Int)? {
