...
final class OpenRouterProvider: NSObject, SuperLLMProvider, SuperLog, @unchecked Sendable {
    ...
    static let modelCatalog: [LLMModelCatalogItem] = [
        ...
        .init(id: "minimax/minimax-m2.1", spec: .init(contextWindowSize: 204_800, supportsVision: false, supportsTools: true)),
        .init(id: "minimax/minimax-m2.5:free", spec: .init(contextWindowSize: 204_800, supportsVision: false, supportsTools: true)),
