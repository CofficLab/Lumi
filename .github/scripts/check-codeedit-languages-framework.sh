...
FRAMEWORK_DIR="$ROOT_DIR/Packages/EditorCodeEditLanguages/CodeLanguagesContainer.xcframework"
...
EditorCodeEditLanguages uses a generated binary framework for bundled tree-sitter
