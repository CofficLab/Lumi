...
### 4. 关键限制说明
由于我无法修改 Xcode 的 `.xcodeproj` 文件来添加 Target，**您需要手动执行添加 Target 的操作**。我将提供所有必要的 Swift 代码和详细的操作指南。

确认后，我将首先实现 **Phase 1**（主应用插件部分）和 **Phase 3**（扩展代码逻辑），并为您准备好用于 Extension 的代码文件。