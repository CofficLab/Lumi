...
Adds context menu actions for multi-cursor editing (add next occurrence, select all, clear).
...
|------|-----|
| **层级** | 插件扩展层 — 编辑器命令/集成插件 |
| **职责** | Adds context menu actions for multi-cursor editing (add next occurrence, select all, clear). |
