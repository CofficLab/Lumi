...
//
// 当前文件仍通过 swizzle 拦截 EditorTextView 的原生输入回调，
...
@MainActor
public final class MultiCursorInputInstaller: NSObject {

    public static let shared = MultiCursorInputInstaller()
    ...
    public func register(textView: TextView, state: EditorState) {
    ...
    public static func helper(for textView: TextView) -> MultiCursorInputHelper? {
...
@MainActor
public final class MultiCursorInputHelper: NSObject {

    private weak var textView: TextView?
    private weak var state: EditorState?
    private var isApplyingMultiCursorEdit = false

    public init(textView: TextView, state: EditorState) {
        self.textView = textView
        self.state = state
    }

    public func handleInsertText(_ string: Any, replacementRange: NSRange) -> Bool {
    ...
    public func handleDeleteBackward() -> Bool {
        guard let textView, let state else { return false }
        guard !isApplyingMultiCursorEdit else { return false }
    ...
    public func handleInsertNewline() -> Bool {
        guard let textView, let state else { return false }
        guard !isApplyingMultiCursorEdit else { return false }
    ...
    public func handleInsertTab() -> Bool {
        guard let textView, let state else { return false }
        guard !isApplyingMultiCursorEdit else { return false }
    ...
    public func handleInsertBacktab() -> Bool {
        guard let textView, let state else { return false }
        guard !isApplyingMultiCursorEdit else { return false }
    ...
    public func handlePerformKeyEquivalent(_ event: NSEvent) -> Bool {
        guard let textView, let state else { return false }
    ...
    public func handleMoveLeft() -> Bool {
        handleMove(selectorName: "moveLeft")
    }

    public func handleMoveRight() -> Bool {
        handleMove(selectorName: "moveRight")
    }

    public func handleCancelOperation() -> Bool {
        guard let textView, let state else { return false }
