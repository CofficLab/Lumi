...
LLM provider plugin for Lumi. Integrates **LPgpt** — LPgpt LLM Gateway.

## Features

- **LLM Provider** — registers LPgpt in the model selector
- **Model catalog** — provides available models for LPgpt
...
- **Request Handling** — sends chat completion requests to LPgpt
