...
public actor ModelPreferencePlugin: SuperPlugin, SuperLog {
    ...
    public static let displayName = LumiPluginLocalization.string("Model Preference", bundle: .module)
    public static let description = LumiPluginLocalization.string("Remember provider and model per conversation", bundle: .module)
