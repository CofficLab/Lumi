...
public actor EditorMarkdownPlugin: SuperPlugin {
    ...
    public static let displayName = String(localized: "Markdown Highlight", bundle: .module)
    public static let description = String(localized: "Provides Markdown-aware highlight ranges for headings, lists, quotes, links, and code spans.", bundle: .module)
