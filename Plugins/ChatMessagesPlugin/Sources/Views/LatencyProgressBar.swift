...
public struct LatencyProgressBar: View {
    /// 首 Token 延迟时间（毫秒）
    ...
    private var helpText: String {
        ...
        🕐 \(String(localized: "Response Time")): \(formatLatency(totalLatency)) (\(responsePercent)%)

        \(String(localized: "TTFT Help"))
        \(String(localized: "Response Time Help"))
        """
    }
}
