...
public struct CSSPropertyDefinition: Sendable {
...
public enum CSSKnowledgeBase {
    public static let supportedLanguageIDs: Set<String> = ["css", "scss", "sass", "less"]

    public static let globalValues: [String] = [
        "inherit", "initial", "unset", "revert", "revert-layer"
    ]

    public static let valueDocs: [String: String] = [
    ...
    public static let properties: [CSSPropertyDefinition] = [
    ...
    public static let propertyMap: [String: CSSPropertyDefinition] = Dictionary(
        uniqueKeysWithValues: properties.map { ($0.name.lowercased(), $0) }
    )

    public static func isSupported(languageId: String) -> Bool {
        supportedLanguageIDs.contains(languageId.lowercased())
    }

    public static func propertySuggestions(prefix: String) -> [EditorCompletionSuggestion] {
    ...
    public static func valueSuggestions(prefix: String) -> [EditorCompletionSuggestion] {
        let normalized = prefix.trimmingCharacters(in: .whitespacesAndNewlines).lowercased()
    ...
    public static func hoverMarkdown(for symbol: String) -> String? {
