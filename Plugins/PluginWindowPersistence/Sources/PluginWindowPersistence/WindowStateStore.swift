...
public final class WindowStateStore: @unchecked Sendable, SuperLog {
    public nonisolated static var emoji: String { WindowPersistencePlugin.emoji }
    public nonisolated static var verbose: Bool { WindowPersistencePlugin.verbose }
    public nonisolated static var logger: Logger { WindowPersistencePlugin.logger }
