...
LLM provider plugin for Lumi. Integrates **Xybbz** — Xybbz LLM Gateway.

## Features

- **LLM Provider** — registers Xybbz in the model selector
- **Model catalog** — provides available models for Xybbz
...
- **Request Handling** — sends chat completion requests to Xybbz
