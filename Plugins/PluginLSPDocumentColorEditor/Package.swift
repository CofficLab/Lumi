...
let package = Package(
    name: "PluginLSPDocumentColorEditor",
    ...
    products: [
        .library(
            name: "PluginLSPDocumentColorEditor",
            targets: ["PluginLSPDocumentColorEditor"]
        )
    ],
    dependencies: [
    ...
    targets: [
        .target(
            ...
            path: "Sources/PluginLSPDocumentColorEditor",
            resources: [
                .process("Resources")
            ]
        ),
        .testTarget(
            name: "PluginLSPDocumentColorEditorTests",
            dependencies: ["PluginLSPDocumentColorEditor"],
            path: "Tests/PluginLSPDocumentColorEditorTests"
        )
    ]
)
