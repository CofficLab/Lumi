...
public actor RegistryService {
    ...
    public func getCurrentRegistry(for type: RegistryType) async throws -> String {
        do {
            switch type {
            case .npm:
    ...
    public func setRegistry(for type: RegistryType, url: String) async throws {
        switch type {
        case .npm:
