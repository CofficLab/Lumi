...
public final class AgentOpenInGitOKPlugin: LumiPlugin {
    ...
    public func pluginAboutView(kernel: KernelLumi) -> AnyView? {
        AnyView(
            OpenInLandingPage(displayName: LumiPluginLocalization.string("Open in GitOK", bundle: .module), icon: "network", appDescription: LumiPluginLocalization.string("Open current project in GitOK", bundle: .module))
        )
    }
