...
LLM provider plugin for Lumi. Integrates **OpenAI** — OpenAI GPT Models.

## Features

- **LLM Provider** — registers OpenAI in the model selector
- **Model catalog** — provides available models for OpenAI
...
- **Request Handling** — sends chat completion requests to OpenAI
