...
public final class ThemeWinterPlugin: LumiPlugin {
    ...
    public var name: String {
        LumiPluginLocalization.string("Winter Theme", bundle: .module)
    }
    ...
    public func pluginAboutView(kernel: KernelLumi) -> AnyView? {
        AnyView(
            ThemeLandingPage(displayName: LumiPluginLocalization.string("Winter Theme", bundle: .module), icon: "snowflake")
        )
    }
