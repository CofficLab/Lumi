...
LLM provider plugin for Lumi. Integrates **Feifeimiao** — Feifeimiao LLM API.

## Features

- **LLM Provider** — registers Feifeimiao in the model selector
- **Model catalog** — provides available models for Feifeimiao
...
- **Request Handling** — sends chat completion requests to Feifeimiao
