...
public struct SmartApp: Identifiable, Sendable, Equatable, Hashable, SuperLog {
    ...
    public var isNotSample: Bool { !isSample }
    public var hasId: Bool { !id.isEmpty }
    public var hasNoId: Bool { id.isEmpty }
...
extension SmartApp {
    ...
    public static func fromId(_ id: String) -> Self {
    ...
    public static func fromRunningApp(_ app: NSRunningApplication) -> Self {
        return SmartApp(
...
extension SmartApp {
    ...
    public static let appList: [SmartApp] = getRunningAppList().map {
    ...
    public static func getRunningAppList() -> [NSRunningApplication] {
        let workspace = NSWorkspace.shared
        return workspace.runningApplications
    }

    /// Find running app by ID
    public static func getApp(_ id: String, verbose: Bool = false) -> NSRunningApplication? {
    ...
    public static func isProxyApp(_ app: NSRunningApplication) -> Bool {
    ...
    public static func isProxyApp(withId appId: String, name: String? = nil) -> Bool {
        // Common Proxy Apps
