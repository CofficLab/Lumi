...
public actor ProjectsPlugin: SuperPlugin, SuperLog {
    /// 插件专用 Logger
    ...
    @MainActor public func addToolBarCenterView(context: PluginContext) -> AnyView? {
    ...
    /// 提供项目上下文注入中间件
    public nonisolated func sendMiddlewares() -> [any SuperSendMiddleware.Type]? {
