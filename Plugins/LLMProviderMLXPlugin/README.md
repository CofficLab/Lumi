...
LLM provider plugin for Lumi. Integrates **MLX** — Local LLM via Apple MLX.

## Features

- **LLM Provider** — registers MLX in the model selector
- **Model catalog** — provides available models for MLX
...
- **Request Handling** — sends chat completion requests to MLX
