...
public final class FreeModelProvider: LumiLLMProvider, SuperLog, @unchecked Sendable {
    ...
    public static let providerInfo = LumiLLMProviderInfo(
        ...
        modelCapabilities: [
            ...
            "claude-fable-5": .init(supportsVision: true, supportsTools: true, supportsThinking: true),
            "claude-opus-4-8": .init(supportsVision: true, supportsTools: true, supportsThinking: true),
            "claude-opus-4-7": .init(supportsVision: true, supportsTools: true, supportsThinking: true),
