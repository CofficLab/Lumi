...
@MainActor
struct PluginThemeOneDarkTests {
    @Test
    func pluginMetadataIsStable() {
        ...
        #expect(ThemeOneDarkPlugin.enable == true)
    ...
    func localizationCatalogIsPackaged() {
        #expect(PluginThemeOneDarkResources.bundle.url(forResource: "ThemeOneDarkPlugin", withExtension: "xcstrings") != nil)
    }
}
