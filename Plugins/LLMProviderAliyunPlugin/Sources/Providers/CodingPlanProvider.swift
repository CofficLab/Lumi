...
public final class CodingPlanProvider: LumiLLMProvider, @unchecked Sendable {
    ...
    public static let info = LumiLLMProviderInfo(
        ...
        availableModels: [
            ...
            .init(id: "qwen3.5-plus", contextWindowSize: 131072, capabilities: .init(supportsVision: true, supportsTools: true, thinkingAndReasoning: .fourLevel)),
            .init(id: "qwen3-max-2026-01-23", contextWindowSize: 1000000, capabilities: .init(supportsVision: false, supportsTools: true, thinkingAndReasoning: .fourLevel)),
            .init(id: "qwen3-coder-next", contextWindowSize: 1000000, capabilities: .init(supportsVision: false, supportsTools: false, thinkingAndReasoning: .fourLevel)),
            .init(id: "qwen3-coder-plus", contextWindowSize: 1000000, capabilities: .init(supportsVision: false, supportsTools: false, thinkingAndReasoning: .fourLevel)),
            .init(id: "kimi-k2.5", contextWindowSize: 262144, capabilities: .init(supportsVision: true, supportsTools: true)),
            .init(id: "glm-5", contextWindowSize: 1000000, capabilities: .init(supportsVision: false, supportsTools: true)),
            .init(id: "glm-4.7", contextWindowSize: 128000, capabilities: .init(supportsVision: false, supportsTools: true)),
