...
public final class AliyunProvider: LumiLLMProvider, @unchecked Sendable {
    ...
    public static let info = LumiLLMProviderInfo(
        ...
        availableModels: [
            ...
            .init(id: "qwen3.5-plus", contextWindowSize: 131_072, capabilities: .init(supportsVision: true, supportsTools: true, supportsThinking: true)),
            .init(id: "qwen3-max-2026-01-23", contextWindowSize: 1_000_000, capabilities: .init(supportsVision: false, supportsTools: true, supportsThinking: true)),
            .init(id: "qwen3-coder-next", contextWindowSize: 1_000_000, capabilities: .init(supportsVision: false, supportsTools: false, supportsThinking: true)),
            .init(id: "qwen3-coder-plus", contextWindowSize: 1_000_000, capabilities: .init(supportsVision: false, supportsTools: false, supportsThinking: true)),
