...
public final class TokenPlanProvider: LumiLLMProvider, @unchecked Sendable {
    ...
    public static let info = LumiLLMProviderInfo(
        ...
        availableModels: [
            .init(id: "qwen3.6-flash", contextWindowSize: 1000000, capabilities: .init(supportsVision: true, supportsTools: true, thinkingAndReasoning: .fourLevel)),
            .init(id: "qwen3.6-plus", contextWindowSize: 1000000, capabilities: .init(supportsVision: true, supportsTools: true, thinkingAndReasoning: .fourLevel)),
            .init(id: "qwen3.7-plus", contextWindowSize: 1000000, capabilities: .init(supportsVision: true, supportsTools: true, thinkingAndReasoning: .fourLevel)),
            .init(id: "qwen3.7-max", contextWindowSize: 1000000, capabilities: .init(supportsVision: false, supportsTools: true, thinkingAndReasoning: .fourLevel)),
            .init(id: "qwen-image-2.0", contextWindowSize: 32768, capabilities: .init(supportsVision: true, supportsTools: false)),
            .init(id: "qwen-image-2.0-pro", contextWindowSize: 32768, capabilities: .init(supportsVision: true, supportsTools: false)),
            .init(id: "wan2.7-image", contextWindowSize: 32768, capabilities: .init(supportsVision: false, supportsTools: false)),
            .init(id: "wan2.7-image-pro", contextWindowSize: 32768, capabilities: .init(supportsVision: false, supportsTools: false)),
            .init(id: "deepseek-v3.2", contextWindowSize: 131072, capabilities: .init(supportsVision: false, supportsTools: true, thinkingAndReasoning: .fourLevel)),
            .init(id: "deepseek-v4-flash", contextWindowSize: 131072, capabilities: .init(supportsVision: true, supportsTools: true, thinkingAndReasoning: .fourLevel)),
            .init(id: "deepseek-v4-pro", contextWindowSize: 131072, capabilities: .init(supportsVision: true, supportsTools: true, thinkingAndReasoning: .fourLevel)),
            .init(id: "kimi-k2.5", contextWindowSize: 262144, capabilities: .init(supportsVision: false, supportsTools: true)),
            .init(id: "kimi-k2.6", contextWindowSize: 262144, capabilities: .init(supportsVision: true, supportsTools: true)),
            .init(id: "kimi-k2.7-code", contextWindowSize: 262144, capabilities: .init(supportsVision: true, supportsTools: true)),
            .init(id: "glm-5", contextWindowSize: 1000000, capabilities: .init(supportsVision: true, supportsTools: true)),
            .init(id: "glm-5.1", contextWindowSize: 1000000, capabilities: .init(supportsVision: true, supportsTools: true)),
            .init(id: "glm-5.2", contextWindowSize: 1000000, capabilities: .init(supportsVision: true, supportsTools: true)),
            .init(id: "MiniMax-M2.5", contextWindowSize: 204800, capabilities: .init(supportsVision: false, supportsTools: true)),
        ],
    ...
    public init(baseURL: String = "https://token-plan.cn-beijing.maas.aliyuncs.com/apps/anthropic", network: (any NetworkProviding)? = nil) {
