...
public final class AliyunTokenPlanProvider: LumiLLMProvider, @unchecked Sendable {
    ...
    public static let info = LumiLLMProviderInfo(
        ...
        availableModels: [
            .init(id: "qwen3.6-flash", contextWindowSize: 1_000_000, capabilities: .init(supportsVision: true, supportsTools: true, supportsThinking: true)),
            .init(id: "qwen3.6-plus", contextWindowSize: 1_000_000, capabilities: .init(supportsVision: true, supportsTools: true, supportsThinking: true)),
            .init(id: "qwen3.7-plus", contextWindowSize: 1_000_000, capabilities: .init(supportsVision: true, supportsTools: true, supportsThinking: true)),
            .init(id: "qwen3.7-max", contextWindowSize: 1_000_000, capabilities: .init(supportsVision: false, supportsTools: true, supportsThinking: true)),
            ...
            .init(id: "deepseek-v3.2", contextWindowSize: 131_072, capabilities: .init(supportsVision: false, supportsTools: true, supportsThinking: true)),
            .init(id: "deepseek-v4-flash", contextWindowSize: 131_072, capabilities: .init(supportsVision: true, supportsTools: true, supportsThinking: true)),
            .init(id: "deepseek-v4-pro", contextWindowSize: 131_072, capabilities: .init(supportsVision: true, supportsTools: true, supportsThinking: true)),
