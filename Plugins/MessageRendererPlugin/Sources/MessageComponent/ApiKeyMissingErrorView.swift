...
public struct ApiKeyMissingErrorView: View {
    ...
    private var languagePreference: LanguagePreference {
        MessageRendererRuntime.languagePreference
    }
    ...
    private var currentProvider: LLMProviderInfo? {
        MessageRendererRuntime.providerInfoProvider(currentProviderId)
    }
    ...
    private func initializeProviderAndApiKey() {
        ...
        if let messageProviderId = message.providerId, !messageProviderId.isEmpty {
            ...
            currentProviderId = MessageRendererRuntime.selectedProviderIdProvider()
        }
