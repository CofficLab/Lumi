...
public actor EditorKotlinPlugin: SuperPlugin {
    ...
    public static let displayName = LumiPluginLocalization.string("Kotlin Highlight", bundle: .module)
    public static let description = LumiPluginLocalization.string("Syntax highlighting and language detection for Kotlin.", bundle: .module)
