...
LLM provider plugin for Lumi. Integrates **AiRouter** — AiRouter LLM Gateway.

## Features

- **LLM Provider** — registers AiRouter in the model selector
- **Model catalog** — provides available models for AiRouter
...
- **Request Handling** — sends chat completion requests to AiRouter
