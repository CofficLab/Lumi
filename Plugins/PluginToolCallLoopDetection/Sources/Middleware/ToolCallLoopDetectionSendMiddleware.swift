...
@MainActor
public struct ToolCallLoopDetectionSuperSendMiddleware: SuperSendMiddleware {
    public let id: String = "tool-call-loop-detection"
    public let order: Int = 100  // 较晚执行，在其他预处理之后
    private let repeatedToolWindowThreshold = 3
    ...
    private func detectToolLoopPattern(
        ...
        let recentMessages = Array(ctx.previousMessages.suffix(100))
    ...
    private func handleDetectedLoop(
        ...
        ToolCallLoopDetectionPlugin.logger.warning("""
    ...
    private func repeatedToolLoopMessage(
