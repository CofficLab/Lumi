...
public final class ThemeOrchardPlugin: LumiPlugin {
    ...
    public var name: String {
        LumiPluginLocalization.string("Orchard Theme", bundle: .module)
    }
    ...
    public func pluginAboutView(kernel: KernelLumi) -> AnyView? {
        AnyView(
            ThemeLandingPage(displayName: LumiPluginLocalization.string("Orchard Theme", bundle: .module), icon: "apple.logo")
        )
    }
