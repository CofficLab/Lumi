...
LLM provider plugin for Lumi. Integrates **小米** — Xiaomi MiMo Models.

## Features

- **LLM Provider** — registers 小米 in the model selector
- **Model catalog** — provides available models for 小米
...
- **Request Handling** — sends chat completion requests to 小米
