            ...
            HStack(spacing: 12) {
                ...
                HStack(spacing: 12) {
                    if isChecking {
                        ...
                        .buttonStyle(.plain)
                        .help(LumiPluginLocalization.string("Re-check availability"))
                    }
    ...
    private var statusBadge: some View {
        if isChecking {
            HStack(spacing: 4) {
                ProgressView()
                    .scaleEffect(0.5)
                Text(verbatim: LumiPluginLocalization.string("Checking"))
                    .font(.system(size: 11, weight: .medium))
            ...
            HStack(spacing: 4) {
                Circle()
                    ...
                    .frame(width: 6, height: 6)
                Text(verbatim: LumiPluginLocalization.string("Unavailable"))
                    .font(.system(size: 11, weight: .medium))
