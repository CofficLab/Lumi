...
LLM provider plugin for Lumi. Integrates **Anthropic** — Claude AI by Anthropic.

## Features

- **LLM Provider** — registers Anthropic in the model selector
- **Model catalog** — provides available models for Anthropic
...
- **Request Handling** — sends chat completion requests to Anthropic
