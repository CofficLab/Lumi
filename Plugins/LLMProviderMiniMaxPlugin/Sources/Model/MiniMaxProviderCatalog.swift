...
enum MiniMaxProviderCatalog {
    static let models: [LumiModelInfo] = [
        .init(
            ...
            // .threeLevel: low/medium/high (closest match; Responses API has minimal/low/medium/high)
            capabilities: .init(supportsVision: true, supportsTools: true, thinkingAndReasoning: .threeLevel)
        ),
        .init(
            id: "MiniMax-M2.7",
