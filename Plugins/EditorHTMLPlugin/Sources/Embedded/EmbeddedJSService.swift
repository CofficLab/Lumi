...
@MainActor
public final class EmbeddedJSService {
    /// 单例
    public static let shared = EmbeddedJSService()
    ...
    /// 检查给定坐标是否在 JS/TS 区域内
    public func isInJSRegion(line: Int, character: Int, sourceLines: [String]) -> Bool {
    ...
    /// 获取区域的语言类型
    public func languageAt(line: Int, character: Int, sourceLines: [String]) -> String? {
