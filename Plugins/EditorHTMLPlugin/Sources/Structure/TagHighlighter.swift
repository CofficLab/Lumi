...
@MainActor
public final class TagHighlighter: SuperEditorDecorationContributor {
    public let id = "html.tag-highlighter"
    ...
    /// 高亮颜色配置
    public static let highlightColor = NSColor.systemBlue.withAlphaComponent(0.15)
    public static let borderColor = NSColor.systemBlue.withAlphaComponent(0.4)
    ...
    public static func highlightRegions(lines: [String], line: Int, character: Int) -> [(line: Int, startColumn: Int, length: Int)] {
