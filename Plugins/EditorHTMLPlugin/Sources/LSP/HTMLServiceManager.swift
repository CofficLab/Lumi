...
@MainActor
public final class HTMLServiceManager {
    /// 单例实例
    public static let shared = HTMLServiceManager()
    ...
    /// 检查是否支持 HTML 语言服务
    public func isAvailable(for languageId: String) -> Bool {
    ...
    /// 获取悬浮提示
    public func provideHover(for symbol: String) -> String? {
