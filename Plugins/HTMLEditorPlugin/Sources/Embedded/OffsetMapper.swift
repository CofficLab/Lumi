...
public enum OffsetMapper {
    ...
    public static func absoluteOffset(line: Int, character: Int, in sourceLines: [String]) -> Int {
        var offset = 0
    ...
    /// 从绝对偏移量计算行号和列号
    public static func lineAndCharacter(from offset: Int, in sourceLines: [String]) -> (line: Int, character: Int)? {
        var currentOffset = 0
