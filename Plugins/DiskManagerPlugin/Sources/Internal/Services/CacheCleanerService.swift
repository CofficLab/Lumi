...
public final class CacheCleanerService: @unchecked Sendable {
    ...
    private var scanRules: [CacheScanRule] {
        ...
        return [
            .init(level: .safe, id: "user_app_cache", name: LumiPluginLocalization.string("App Cache", bundle: .module), desc: LumiPluginLocalization.string("Clear temporary files generated by applications", bundle: .module), icon: "app.badge", paths: ["\(home)/Library/Caches"]),
            .init(level: .safe, id: "browser_cache", name: LumiPluginLocalization.string("Browser Cache", bundle: .module), desc: LumiPluginLocalization.string("Clear Chrome, Safari, Firefox and other browser caches", bundle: .module), icon: "safari", paths: [
                "\(home)/Library/Caches/Google/Chrome",
                "\(home)/Library/Caches/com.apple.Safari",
                "\(home)/Library/Caches/Firefox",
            ]),
            .init(level: .safe, id: "dev_cache", name: LumiPluginLocalization.string("Developer Tool Cache", bundle: .module), desc: LumiPluginLocalization.string("Clear Xcode DerivedData, Archives, and package manager caches", bundle: .module), icon: "hammer", paths: [
                "\(home)/Library/Developer/Xcode/DerivedData",
                "\(home)/Library/Developer/Xcode/Archives",
                "\(home)/.npm/_cacache",
                "\(home)/.cargo/registry",
            ]),
            .init(level: .medium, id: "system_logs", name: LumiPluginLocalization.string("System Logs", bundle: .module), desc: LumiPluginLocalization.string("Clear system runtime log files", bundle: .module), icon: "doc.text", paths: [
                "\(home)/Library/Logs",
            ]),
            .init(level: .safe, id: "trash", name: LumiPluginLocalization.string("Trash", bundle: .module), desc: LumiPluginLocalization.string("Empty files in the trash", bundle: .module), icon: "trash", paths: [
                "\(home)/.Trash",
            ]),
        ]
    }
        ...
        for content in contents {
            ...
            if let info = await getPathInfo(content.path), info.size > 0 {
                results.append(CachePath(
                    ...
                    description: LumiPluginLocalization.string("App Cache", bundle: .module),
                    size: info.size,
                    fileCount: info.count,
                    canDelete: true
                ))
