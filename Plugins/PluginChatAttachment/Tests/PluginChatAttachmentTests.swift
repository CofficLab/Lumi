...
@Test func droppedFileURLStringsBecomeFileURLs() {
    ...
    #expect(ChatAttachmentDropRules.fileURL(fromDroppedString: "file:///tmp/a b.png")?.path == "/tmp/a b.png")
    #expect(ChatAttachmentDropRules.fileURL(fromDroppedString: "file://localhost/tmp/a.png")?.path == "/tmp/a.png")
...
@Test func multilineDroppedFileURLStringsBecomeFileURLs() {
    let urls = ChatAttachmentDropRules.fileURLs(fromDroppedString: "file:///tmp/a 1.png\n/tmp/b.png\nrelative/c.png")
