...
public actor LSPServiceEditorPlugin: SuperPlugin {
    ...
    public static let description = String(localized: "Provides the core Language Server Protocol integration including completion, hover, and diagnostics.", table: "LSPServiceEditor")
