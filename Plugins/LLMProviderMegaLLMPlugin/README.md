...
LLM provider plugin for Lumi. Integrates **MegaLLM** — MegaLLM Multi-Provider.

## Features

- **LLM Provider** — registers MegaLLM in the model selector
- **Model catalog** — provides available models for MegaLLM
...
- **Request Handling** — sends chat completion requests to MegaLLM
