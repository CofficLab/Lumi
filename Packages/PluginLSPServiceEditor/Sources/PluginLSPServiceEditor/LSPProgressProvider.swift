...
/// LSP 进度通知提供者
@MainActor
public final class LSPProgressProvider: ObservableObject {

    @Published public private(set) var activeTasks: [String: ProgressTask] = [:]
    ...
    public var primaryActiveTask: ProgressTask? {
        activeTasks.values
    ...
    public func updateProgress(token: String, value: LanguageServerProtocol.LSPAny?) {
