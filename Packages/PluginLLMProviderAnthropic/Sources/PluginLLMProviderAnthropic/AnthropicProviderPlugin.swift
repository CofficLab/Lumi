...
/// 对应旧版 com.coffic.lumi.plugin.llm-provider.anthropic 的 `llmProviders(kernel:)` 贡献职责。
@MainActor
public final class AnthropicProviderPlugin: SuperPlugin {
    ...
    public func onBoot(kernel: KernelCoreContainer) throws {
        ...
        let providers: [any ManagedLLMProvider] = [AnthropicProvider()]
