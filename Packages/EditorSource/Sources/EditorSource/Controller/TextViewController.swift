...
/// # TextViewController
/// 
/// A view controller class for managing a source editor. Uses ``EditorTextView/TextView`` for input and rendering,
...
public class TextViewController: NSViewController {
    ...
    var textViewTrailingInset: CGFloat {
        // See https://github.com/CodeEditApp/EditorTextView/issues/66
        // wrapLines ? 1 : 48
