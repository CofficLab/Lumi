...
@MainActor
public final class LSPSheetContributor: SuperEditorSheetContributor {
    public let id: String = "builtin.lsp.sheets"

    public func provideSheets(state: EditorState) -> [EditorSheetSuggestion] {
        [
            .init(
