...
public struct GitCommitSubAgentDefinition: SubAgentDefinitionProtocol {
    public let id = "git.commit"
    public let name = "Git Commit Agent"
    public let description = "Analyze the current Git working tree and create a focused commit."
    public let allowedToolNames = ["git_status", "git_diff", "git_log", "git_commit"]
    public let maxTurns = 8
    ...
    public let resultTemplate = SubAgentResultTemplate(
