...
/// Mind Map Designer 技能贡献者：从插件资源目录加载思维导图设计指南技能。
///
/// 技能以标准目录格式存放在插件自己的资源目录
/// （`Resources/Skills/mind-map-designer/`：`metadata.json` + `SKILL.md`），
...
public struct MindMapDesignerSkillContributor: SkillContributing {
    public let providerID: String
    public let skills: [SkillMetadata]

    public init(
        providerID: String = "com.coffic.lumi.plugin.mind-map",
