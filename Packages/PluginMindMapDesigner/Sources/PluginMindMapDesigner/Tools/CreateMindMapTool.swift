...
public struct CreateMindMapTool: SuperAgentTool {
    public let name = "create_mind_map"

    public init() {}

    public func description(for language: LanguagePreference) -> String {
        "Create a new mind map with a root node. The root text usually represents the central topic. Returns the new map id."
    }
    ...
    public func inputSchema(for language: LanguagePreference) -> [String: Any] {
        ...
        return ["type": "object", "properties": properties, "required": ["rootText"]]
    }

    public func displayDescription(for arguments: [String: ToolArgument]) -> String {
        MindMapToolSupport.localized(MindMapToolSupport.language, en: "Create mind map", zh: "创建思维导图")
    }
