...
@MainActor public final class AppManagerSuperPlugin: SuperPlugin, SuperLog {
    ...
    public func onBoot(kernel: KernelCoreContainer) throws {
        ...
        rail?.addTabs([RailTabItem(id: AppManagerPlugin.railTabID, groupID: id, title: LumiPluginLocalization.string("Apps", bundle: .module), systemImage: "apps.ipad", order: order) { AppRailView(viewModel: self.viewModel) }])
