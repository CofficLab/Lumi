...
public struct AddIconShapeTool: SuperAgentTool {
    ...
    public func description(for language: LanguagePreference) -> String {
        "Add a vector layer to the current icon document. Supports rectangle, circle, capsule, triangle, line, symbol, and text."
    }
    ...
    public func inputSchema(for language: LanguagePreference) -> [String: Any] {
        ...
        return ["type": "object", "properties": properties, "required": ["shape"]]
    }
