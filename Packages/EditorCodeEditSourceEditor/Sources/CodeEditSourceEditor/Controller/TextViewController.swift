...
/// # TextViewController
/// 
/// A view controller class for managing a source editor. Uses ``EditorCodeEditTextView/TextView`` for input and rendering,
...
public class TextViewController: NSViewController {
    ...
    var textViewTrailingInset: CGFloat {
        // See https://github.com/CodeEditApp/EditorCodeEditTextView/issues/66
        // wrapLines ? 1 : 48
