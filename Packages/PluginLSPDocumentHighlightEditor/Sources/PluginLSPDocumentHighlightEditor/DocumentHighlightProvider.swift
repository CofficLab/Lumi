...
/// 高亮当前光标所在位置的所有符号引用
@MainActor
public final class DocumentHighlightProvider: ObservableObject, SuperEditorDocumentHighlightProvider {
    ...
    @Published public var highlightRanges: [NSRange] = []
    
    /// 请求文档高亮
    public func requestHighlight(uri: String, line: Int, character: Int, content: String) async {
