...
/// IdleTime Provider 装配测试：验证 FactoryLumi2 把完整服务装配进内核，
/// 而非占位内存桩。
@Suite("FactoryLumi2 IdleTime 装配")
@MainActor
struct FactoryLumi2IdleTimeTests {
    ...
    private final class TestStorage: StorageProviding {
        ...
        init() {
            dataRootDirectory = FileManager.default.temporaryDirectory
                .appendingPathComponent("FactoryLumi2IdleTimeTests-\(UUID().uuidString)")
        }
