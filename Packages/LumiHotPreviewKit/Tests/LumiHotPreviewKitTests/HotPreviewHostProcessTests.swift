...
struct HotPreviewHostProcessTests {
    ...
    func interposesLivePreviewDylib() async throws {
        ...
        let connection = try await LumiHotPreviewPackage.HotPreviewHostProcess().launch(executableURL: executableURL)
        defer {
            Task {
    ...
    private func frameBytes(from response: LumiHotPreviewPackage.HotRenderResponse) throws -> Data {
