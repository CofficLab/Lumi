...
struct CompileCommandCacheTests {
    ...
    func storesAndReloadsCommands() async throws {
        ...
        let cache = LumiHotPreviewPackage.CompileCommandCache(cacheDirectory: directory)
        ...
        let reloaded = LumiHotPreviewPackage.CompileCommandCache(cacheDirectory: directory)
