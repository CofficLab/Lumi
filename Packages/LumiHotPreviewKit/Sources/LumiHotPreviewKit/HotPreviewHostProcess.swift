...
public extension LumiHotPreviewPackage.HotHostConnection {
    @discardableResult
    func requestCaptureFrame() async throws -> LumiHotPreviewPackage.HotRenderResponse {
        try await requestCaptureFrame(includeImageFallback: true)
    }
}

private final class ProcessHotHostConnection: LumiHotPreviewPackage.HotHostConnection, @unchecked Sendable {
    ...
    func requestRender(
        discovery: LumiPreviewPackage.PreviewDiscovery,
        configuration: LumiPreviewPackage.PreviewRenderConfiguration
    ) async throws -> LumiHotPreviewPackage.HotRenderResponse {
        let request = LumiHotPreviewPackage.HotHostRequest(
            command: .render,
            discovery: discovery,
    ...
    @discardableResult
    func requestRefresh() async throws -> LumiHotPreviewPackage.HotRenderResponse {
        try send(LumiHotPreviewPackage.HotHostRequest(command: .refresh))
    }

    @discardableResult
    func requestCaptureFrame(includeImageFallback: Bool) async throws -> LumiHotPreviewPackage.HotRenderResponse {
        let request = LumiHotPreviewPackage.HotHostRequest(
    ...
    @discardableResult
    func requestLoadPreviewEntry(at dylibURL: URL, symbolName: String) async throws -> LumiHotPreviewPackage.HotRenderResponse {
        let request = LumiHotPreviewPackage.HotHostRequest(
            command: .loadDylib,
    ...
    @discardableResult
    func requestInterposeDylib(at dylibURL: URL, symbolName: String?) async throws -> LumiHotPreviewPackage.HotRenderResponse {
        let request = LumiHotPreviewPackage.HotHostRequest(
    ...
    @discardableResult
    func requestStartLivePreview() async throws -> LumiHotPreviewPackage.HotRenderResponse {
        try send(LumiHotPreviewPackage.HotHostRequest(command: .startLivePreview))
    }
    ...
    @discardableResult
    func requestShowLivePreview() async throws -> LumiHotPreviewPackage.HotRenderResponse {
        try send(LumiHotPreviewPackage.HotHostRequest(command: .showLivePreview))
    }

    @discardableResult
    func requestHideLivePreview() async throws -> LumiHotPreviewPackage.HotRenderResponse {
        try send(LumiHotPreviewPackage.HotHostRequest(command: .hideLivePreview))
    }

    @discardableResult
    func requestReloadLivePreview(at dylibURL: URL, symbolName: String) async throws -> LumiHotPreviewPackage.HotRenderResponse {
        let request = LumiHotPreviewPackage.HotHostRequest(
    ...
    @discardableResult
    func requestStopLivePreview() async throws -> LumiHotPreviewPackage.HotRenderResponse {
        try send(LumiHotPreviewPackage.HotHostRequest(command: .stopLivePreview))
    }
    ...
    private func send(_ request: LumiHotPreviewPackage.HotHostRequest) throws -> LumiHotPreviewPackage.HotRenderResponse {
        lock.lock()
        defer { lock.unlock() }
        ...
        do {
            let response = try decoder.decode(LumiHotPreviewPackage.HotRenderResponse.self, from: line)
