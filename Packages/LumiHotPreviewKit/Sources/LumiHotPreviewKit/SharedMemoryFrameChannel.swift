    ...
    final class SharedMemoryFrameChannel: @unchecked Sendable {
        ...
        public static func defaultDirectory(fileManager: FileManager = .default) -> URL {
            fileManager.temporaryDirectory
                .appendingPathComponent("LumiHotPreviewKit", isDirectory: true)
...
private protocol FrameStorageBackend: Sendable {
    var kind: LumiHotPreviewPackage.SharedMemoryFrameChannel.BackendKind { get }
...
private struct MappedFileFrameStorageBackend: FrameStorageBackend {
    var kind: LumiHotPreviewPackage.SharedMemoryFrameChannel.BackendKind { .mappedFile }
...
private struct MachFrameStorageBackend: FrameStorageBackend {
    var kind: LumiHotPreviewPackage.SharedMemoryFrameChannel.BackendKind { .mach }
