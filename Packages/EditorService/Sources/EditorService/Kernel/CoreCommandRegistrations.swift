...
enum CoreCommandRegistrations {
    ...
    private static func registerNavigationCommands(state: EditorState) {
        CommandRegistry.shared.register(KernelEditorCommand.command(
            ...
            NotificationCenter.default.post(name: Notification.Name("LumiEditorToggleOpenEditorsPanel"), object: nil)
        })
        ...
        CommandRegistry.shared.register(KernelEditorCommand.command(
            ...
            NotificationCenter.default.post(name: Notification.Name("LumiEditorToggleOutlinePanel"), object: nil)
        })
    ...
    private static func registerWorkbenchCommands() {
        CommandRegistry.shared.register(KernelEditorCommand.command(
            ...
            NotificationCenter.default.post(name: Notification.Name("LumiEditorShowCommandPalette"), object: nil)
        })
    }
    ...
    private static func registerLSPActionCommands(state: EditorState) {
        CommandRegistry.shared.register(KernelEditorCommand.command(
            ...
            NotificationCenter.default.post(name: Notification.Name("LumiEditorTriggerCompletion"), object: nil)
        })
        ...
        CommandRegistry.shared.register(KernelEditorCommand.command(
            ...
            NotificationCenter.default.post(name: Notification.Name("LumiEditorTriggerSignatureHelp"), object: nil)
        })
    }
