...
public final class LanguageServer: @unchecked Sendable, SuperLog {
    ...
    public var onPublishDiagnostics: ((PublishDiagnosticsParams) -> Void)?
    public var onProgressUpdate: ((String, LanguageServerProtocol.LSPAny?) -> Void)?
    ...
    public static func makeInitParams(
        workspacePath: String,
        workspaceFolders: [LanguageServerProtocol.WorkspaceFolder]? = nil,
        initializationOptions: LanguageServerProtocol.LSPAny? = nil
    ...
    public func openDocument(uri: String, languageId: String, text: String, version: Int = 0) async throws {
    ...
    public func documentDidSave(uri: String, text: String? = nil) async throws {
    ...
    public func documentDidChange(uri: String, text: String, version explicitVersion: Int? = nil) async throws {
    ...
    public func documentDidChange(uri: String, changes: [DocumentChange], fullText: String?, version explicitVersion: Int? = nil) async throws {
    ...
    public func completion(uri: String, line: Int, character: Int) async throws -> CompletionResponse {
    ...
    public func hover(uri: String, line: Int, character: Int) async throws -> HoverResponse {
    ...
    public func definition(uri: String, line: Int, character: Int) async throws -> DefinitionResponse {
        let params = TextDocumentPositionParams(
            textDocument: TextDocumentIdentifier(uri: uri),
            position: Position(line: line, character: character)
        )
    ...
    public func references(uri: String, line: Int, character: Int) async throws -> [Location] {
    ...
    public func documentSymbols(uri: String) async throws -> [DocumentSymbol] {
    ...
    public func rename(uri: String, line: Int, character: Int, newName: String) async throws -> WorkspaceEdit? {
    ...
    public func formatting(uri: String, tabSize: Int, insertSpaces: Bool) async throws -> [TextEdit]? {
    ...
    public func semanticTokens(uri: String) async throws -> SemanticTokens? {
    ...
    public func semanticTokensDelta(uri: String, previousResultId: String) async throws -> SemanticTokensDeltaResponse {
    ...
    public func signatureHelp(uri: String, line: Int, character: Int) async throws -> SignatureHelpResponse {
        let params = TextDocumentPositionParams(
            textDocument: TextDocumentIdentifier(uri: uri),
            position: Position(line: line, character: character)
        )
    ...
    public func inlayHint(uri: String, startLine: Int, startCharacter: Int, endLine: Int, endCharacter: Int) async throws -> InlayHintResponse {
        let range = LSPRange(
    ...
    public func documentHighlight(uri: String, line: Int, character: Int) async throws -> [DocumentHighlight] {
    ...
    public func codeActionResolve(_ action: CodeAction) async throws -> CodeAction {
        try await server.codeActionResolve(action)
    }
    
    public func declaration(uri: String, line: Int, character: Int) async throws -> DeclarationResponse {
        let params = TextDocumentPositionParams(
            textDocument: TextDocumentIdentifier(uri: uri),
            position: Position(line: line, character: character)
        )
    ...
    public func typeDefinition(uri: String, line: Int, character: Int) async throws -> TypeDefinitionResponse {
        let params = TextDocumentPositionParams(
            textDocument: TextDocumentIdentifier(uri: uri),
            position: Position(line: line, character: character)
        )
    ...
    public func implementation(uri: String, line: Int, character: Int) async throws -> ImplementationResponse {
        let params = TextDocumentPositionParams(
            textDocument: TextDocumentIdentifier(uri: uri),
            position: Position(line: line, character: character)
        )
    ...
    public func foldingRange(uri: String) async throws -> FoldingRangeResponse {
    ...
    public func selectionRange(uri: String, line: Int, character: Int) async throws -> [SelectionRange]? {
    ...
    public func documentLink(uri: String) async throws -> [DocumentLink]? {
    ...
    public func resolveDocumentLink(_ link: DocumentLink) async throws -> DocumentLink {
        return try await server.sendRequest(.documentLinkResolve(link, ClientRequest.NullHandler))
    }
    
    // MARK: Document Color
    
    public func documentColor(uri: String) async throws -> [ColorInformation] {
    ...
    public func colorPresentation(uri: String, color: Color, range: LSPRange) async throws -> [ColorPresentation] {
    ...
    public func callHierarchyPrepare(uri: String, line: Int, character: Int) async throws -> [CallHierarchyItem]? {
    ...
    public func callHierarchyIncomingCalls(item: CallHierarchyItem) async throws -> [CallHierarchyIncomingCall]? {
    ...
    public func callHierarchyOutgoingCalls(item: CallHierarchyItem) async throws -> [CallHierarchyOutgoingCall]? {
    ...
    public func workspaceSymbol(query: String) async throws -> WorkspaceSymbolResponse {
    ...
    public func executeCommand(command: String, arguments: [LanguageServerProtocol.LSPAny]? = nil) async throws -> LSPAny? {
