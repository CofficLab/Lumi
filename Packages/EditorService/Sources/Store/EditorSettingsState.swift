...
@MainActor
public final class EditorSettingsState: ObservableObject {
    // MARK: - 单例实例
    public static let shared = EditorSettingsState()
    ...
    private func reinstallEditorPlugins() {
        ...
        EditorSettingsLifecycle.onReinstallPlugins?(registry)
    ...
    private func observePluginSettingChanges() {
        NotificationCenter.default.publisher(for: Notification.Name("pluginSettingsChanged"))
