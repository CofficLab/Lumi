...
/// Resume Designer 技能贡献者：从插件资源目录加载简历设计指南技能。
///
/// 技能以标准目录格式存放在插件自己的资源目录
/// （`Resources/Skills/resume-designer/`：`metadata.json` + `SKILL.md`），
...
public struct ResumeDesignerSkillContributor: SkillContributing {
    public let providerID: String
    public let skills: [SkillMetadata]

    public init(
        providerID: String = "com.coffic.lumi.plugin.resume-designer",
