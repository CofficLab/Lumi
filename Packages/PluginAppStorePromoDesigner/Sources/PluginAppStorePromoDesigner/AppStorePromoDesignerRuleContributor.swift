...
/// App Store Promo Designer 插件贡献的 Agent 规则。
public struct AppStorePromoDesignerRuleContributor: AgentRuleContributing {
    public let providerID: String
    private let rules: [AgentRuleDefinition]

    public init(
        providerID: String = "com.coffic.lumi.plugin.app-store-promo-designer",
        resourceName: String = "app-store-promo-designer-workflow"
    ) {
