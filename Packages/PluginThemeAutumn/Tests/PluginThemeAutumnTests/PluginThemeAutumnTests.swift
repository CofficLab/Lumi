...
import LumiUI
import Testing
@testable import PluginThemeAutumn

@MainActor
struct PluginThemeAutumnTests {
    @Test
    ...
    func localizationCatalogIsPackaged() {
        #expect(PluginThemeAutumnResources.bundle.url(forResource: "ThemeAutumnPlugin", withExtension: "xcstrings") != nil)
    }
}
