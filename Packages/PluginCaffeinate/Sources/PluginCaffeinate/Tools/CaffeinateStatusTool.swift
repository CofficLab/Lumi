...
struct CaffeinateStatusTool: SuperAgentTool {
    let name = "caffeinate_status"

    func description(for language: LanguagePreference) -> String {
        "Query the current caffeinate status. Returns whether caffeinate is active, the current mode, duration, elapsed time, and remaining time."
    }
