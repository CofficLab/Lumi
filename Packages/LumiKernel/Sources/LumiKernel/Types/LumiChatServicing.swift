...
public protocol LumiChatServicing: AnyObject, ObservableObject {
    ...
    @discardableResult func createConversation(title: String?) -> UUID
    @discardableResult func createConversation(title: String?, projectPath: String?, language: LumiConversationLanguage?) -> UUID
    func selectConversation(id: UUID)
    func deleteConversation(id: UUID)
    func updateConversationTitle(_ title: String, for conversationID: UUID) -> Bool
    @discardableResult func setConversationProjectPath(_ projectPath: String?, for conversationID: UUID) -> Bool
