...
/// App Store Connect 插件贡献的 Agent 规则。
public struct AppStoreConnectRuleContributor: AgentRuleContributing {
    public let providerID: String
    private let rules: [AgentRuleDefinition]

    public init(
        providerID: String = "com.coffic.lumi.plugin.app-store-connect",
        resourceName: String = "app-store-connect-release-safety"
    ) {
