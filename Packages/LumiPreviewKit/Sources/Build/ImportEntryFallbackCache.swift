        ...
        public func makeCacheKey(
            ...
            CacheKey(
                fingerprint: Self.sha256(
                    [
                        "import-entry-fallback-v2",
                        LumiPreviewFacade.PreviewEntryBuilder.previewDebugConditionArguments.joined(separator: " "),
                        discovery.id,
...
private extension LumiPreviewFacade.ImportEntryFallbackCache {
    static func configurationFingerprint(
        _ configuration: LumiPreviewFacade.PreviewRenderConfiguration
    ) -> String {
