...
final class PreviewSurfaceViewLayerTests: XCTestCase {
    ...
    private func makeSurfaceView(frame: NSRect = NSRect(x: 0, y: 0, width: 320, height: 180)) -> LumiInlinePreviewFacade.PreviewSurfaceView {
        let view = LumiInlinePreviewFacade.PreviewSurfaceView(frame: frame)
