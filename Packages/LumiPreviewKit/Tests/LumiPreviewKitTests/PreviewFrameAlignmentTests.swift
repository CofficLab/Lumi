...
struct PreviewFrameAlignmentTests {
    ...
    func alignsToHalfPointsAtScale2() {
        ...
        let aligned = LumiPreviewFacade.PreviewFrameAlignment.pixelAlignedFrame(frame, scale: 2)
    ...
    func clampsScaleBelowOne() {
        ...
        let aligned = LumiPreviewFacade.PreviewFrameAlignment.pixelAlignedFrame(frame, scale: 0.5)
