...
/// 对应旧版 com.coffic.lumi.plugin.llm-provider.aliyun 的 `llmProviders(kernel:)` 贡献职责。
@MainActor
public final class AliyunProviderPlugin: SuperPlugin {
    ...
    public func onBoot(kernel: KernelCoreContainer) throws {
        ...
        let providers: [any ManagedLLMProvider] = [AliyunProvider(), AliyunTokenPlanProvider()]
