...
///
/// 在 `onBoot` 中把本供应商的 OpenCodeProvider 注册进
/// `LLMProviderManagerProviding`，聊天链路即可经管理器路由到该供应商。
/// 对应旧版 com.coffic.lumi.plugin.llm-provider.opencode 的 `llmProviders(kernel:)` 贡献职责。
@MainActor
public final class OpenCodeProviderPlugin: SuperPlugin {
    ...
    public func onBoot(kernel: KernelCoreContainer) throws {
        ...
        let providers: [any ManagedLLMProvider] = [OpenCodeProvider()]
