...
import LumiUI
import Testing
@testable import PluginThemeGithub

@MainActor
struct PluginThemeGithubTests {
    @Test
    func pluginMetadataIsStable() {
        ...
        #expect(ThemeGithubPlugin.enable == true)
    ...
    func localizationCatalogIsPackaged() {
        #expect(PluginThemeGithubResources.bundle.url(forResource: "ThemeGithubPlugin", withExtension: "xcstrings") != nil)
    }
}
