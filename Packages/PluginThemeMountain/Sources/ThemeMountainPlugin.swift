...
public final class ThemeMountainPlugin: LumiPlugin {
    ...
    public var name: String {
        LumiPluginLocalization.string("Mountain Theme", bundle: .module)
    }
    ...
    public func pluginAboutView(kernel: KernelLumi) -> AnyView? {
        AnyView(
            ThemeLandingPage(displayName: LumiPluginLocalization.string("Mountain Theme", bundle: .module), icon: "mountain.2")
        )
    }
