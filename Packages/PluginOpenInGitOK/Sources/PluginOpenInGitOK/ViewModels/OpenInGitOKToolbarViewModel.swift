...
@MainActor
final class OpenInGitOKToolbarViewModel: ObservableObject {
    let tool: OpenInTool
    ...
    func openProjectInGitOK() {
        ...
        Task { @MainActor [weak self] in
            ...
            do {
                ...
                OpenInGitOKPlugin.logger.error("\(OpenInGitOKPlugin.t)Failed to open project in GitOK: \(error.localizedDescription)")
            }
        }
    }
}
