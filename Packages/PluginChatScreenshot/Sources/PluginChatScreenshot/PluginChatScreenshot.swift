...
///   编码为 `UserImageAttachment` 并加入 `MessageSendingProviding` 的挂起池，
///   由 Conversation Input 插件显示预览并随下一条消息发送。
///
/// 与旧版的对应关系：
...
/// - `kernel.messageSender.addAttachment` →
///   `MessageSendingProviding.addImageAttachment`；
@MainActor
