...
public class ShellService: SuperLog {
    ...
    /// Shell 运行状态变化通知
    public let runningStatePublisher = PassthroughSubject<Bool, Never>()

    // MARK: - Properties

    /// 当前工作目录
    public var currentDirectory: String = FileManager.default.homeDirectoryForCurrentUser.path
    ...
    public func progressSnapshot() async -> ShellExecutionProgressSnapshot? {
...
public struct ShellExecutionProgressSnapshot: Sendable {
