...
public enum GeneratedPluginRegistry {
    ...
    public static var plugins: [any LumiCoreKit.SuperPlugin] {
        ...
        plugins.append(PluginThemeAurora.ThemeAuroraPlugin.shared)
        plugins.append(PluginThemeAutumn.ThemeAutumnPlugin.shared)
        plugins.append(PluginThemeDracula.ThemeDraculaPlugin.shared)
        plugins.append(PluginThemeGithub.ThemeGithubPlugin.shared)
        plugins.append(PluginThemeLumi.ThemeLumiPlugin.shared)
        plugins.append(PluginThemeMidnight.ThemeMidnightPlugin.shared)
        plugins.append(PluginThemeMountain.ThemeMountainPlugin.shared)
        plugins.append(PluginThemeNebula.ThemeNebulaPlugin.shared)
        plugins.append(PluginThemeOneDark.ThemeOneDarkPlugin.shared)
        plugins.append(PluginThemeOrchard.ThemeOrchardPlugin.shared)
        plugins.append(PluginThemeRiver.ThemeRiverPlugin.shared)
        plugins.append(PluginThemeSky.ThemeSkyPlugin.shared)
        plugins.append(PluginThemeSpring.ThemeSpringPlugin.shared)
        plugins.append(PluginThemeStatusBar.ThemeStatusBarPlugin.shared)
        plugins.append(PluginThemeSummer.ThemeSummerPlugin.shared)
        plugins.append(PluginThemeVoid.ThemeVoidPlugin.shared)
        plugins.append(PluginThemeVscodeDark.ThemeVscodeDarkPlugin.shared)
        plugins.append(PluginThemeVscodeLight.ThemeVscodeLightPlugin.shared)
        plugins.append(PluginThemeWinter.ThemeWinterPlugin.shared)
