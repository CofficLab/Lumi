...
let package = Package(
    ...
    dependencies: [
        ...
        .package(path: "../../Plugins/AgentLanguagePlugin"),
        .package(path: "../../Plugins/AgentMCPToolsPlugin"),
        .package(path: "../../Plugins/AgentMessageRendererPlugin"),
        ...
        .package(path: "../../Plugins/ChatMessagesPlugin"),
        ...
        .package(path: "../../Plugins/ToolPermissionPlugin"),
