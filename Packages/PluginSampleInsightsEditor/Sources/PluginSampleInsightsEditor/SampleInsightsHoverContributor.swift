...
@MainActor
public final class SampleInsightsHoverContributor: SuperEditorHoverContentContributor {
    public let id = "sample.insights.hover"
    ...
    public func provideHoverContent(context: EditorHoverContext) async -> [EditorHoverSuggestion] {
