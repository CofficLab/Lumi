...
/// 特点：深邃的蓝灰色基调，色彩平衡且舒适
///
public struct OneDarkTheme: LumiAppChromeTheme {
    // MARK: - 主题信息
    public let identifier = "one-dark"
    public let displayName = "One Dark"
    public let compactName = "One Dark"
    public let description = "Atom One Dark 经典深色配色，舒适且平衡"
    public let iconName = "circle.hexagongrid"
