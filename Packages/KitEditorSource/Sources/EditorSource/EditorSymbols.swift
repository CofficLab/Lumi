...
private final class EditorSourceSymbolsBundleToken {}

private enum EditorSourceSymbolsBundle {
    static var current: Bundle {
        let hostBundle = Bundle(for: EditorSourceSymbolsBundleToken.self)
        ...
        let candidates = [
            ...
            "EditorSource_EditorSource.bundle",
...
public extension Image {
    ...
    init(symbol: String) {
        self.init(symbol, bundle: EditorSourceSymbolsBundle.current)
    }
...
public extension NSImage {
    ...
    static func symbol(named: String) -> NSImage? {
        EditorSourceSymbolsBundle.current.image(forResource: named)
    }
