...
let package = Package(
    name: "PluginMessageListStandard",
    defaultLocalization: "en",
    platforms: [.macOS(.v14)],
    products: [.library(name: "PluginMessageListStandard", targets: ["PluginMessageListStandard"])],
    dependencies: [
    ...
    targets: [
        ...
        .testTarget(name: "PluginMessageListStandardTests", dependencies: [
