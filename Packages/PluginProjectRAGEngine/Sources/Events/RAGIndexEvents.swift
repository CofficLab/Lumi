...
extension Notification.Name {
    ...
    /// - isFinished: Bool
    public static let ragIndexProgressDidChange = Notification.Name("RAG.IndexProgressDidChange")
}

// MARK: - NotificationCenter Extension

extension NotificationCenter {
    public static func postRAGIndexProgress(_ event: RAGIndexProgressEvent) {
...
extension View {
    public func onRAGIndexProgressDidChange(
