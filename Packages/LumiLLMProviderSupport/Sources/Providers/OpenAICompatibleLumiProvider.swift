...
open class OpenAICompatibleLumiProvider: LumiLLMProvider, @unchecked Sendable {
    ...
    static func messageMetadata(from state: StreamingState) async -> [String: String] {
    ...
    static func attachTransportDetails(
        summary: String,
        request: URLRequest,
    ...
    static func maskedHeaders(_ headers: [String: String]) -> [String: String] {
        var masked = headers
    ...
    static func prettyJSON(_ body: [String: Any]) -> String {
    ...
    static func processStreamChunk(
        chunkData: Data,
