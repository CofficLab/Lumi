...
public struct XcodeDestinationContext: Identifiable, Equatable, Sendable, Codable {
...
public struct XcodeBuildConfigurationContext: Identifiable, Equatable, Sendable, Codable {
    public let id: String
    public let name: String
...
/// 代表一个 Xcode Target
public struct XcodeTargetContext: Identifiable, Equatable, Sendable, Codable {
    public let id: String
    public let name: String
...
public struct XcodeSchemeContext: Identifiable, Equatable, Sendable, Codable {
    public let id: String
    public let name: String
...
/// 代表一个 .xcodeproj
public struct XcodeProjectContext: Identifiable, Equatable, Sendable, Codable {
    public let id: String
    public let name: String
    public let path: URL
...
public struct XcodeWorkspaceContext: Identifiable, Equatable, Sendable, Codable {
    public let id: String
    public let name: String
    public let path: URL
