...
public final class ThemeDraculaPlugin: LumiPlugin {
    ...
    public var name: String {
        LumiPluginLocalization.string("Dracula Theme", bundle: .module)
    }
    ...
    public func pluginAboutView(kernel: KernelLumi) -> AnyView? {
        AnyView(
            ThemeLandingPage(displayName: LumiPluginLocalization.string("Dracula Theme", bundle: .module), icon: "moon.stars")
        )
    }
