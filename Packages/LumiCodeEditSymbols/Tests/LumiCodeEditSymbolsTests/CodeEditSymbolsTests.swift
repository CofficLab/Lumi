...
final class CodeEditSymbolsImageTests: XCTestCase {
...
final class CodeEditSymbolsNSImageTests: XCTestCase {
...
final class CodeEditSymbolsBundleTests: XCTestCase {

    func testBundleAccess() {
        // Test that we can access symbols through different bundle paths
        // This indirectly tests CodeEditSymbolsBundle.current
