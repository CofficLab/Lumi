...
@MainActor
public final class FeifeimiaoProviderPlugin: SuperPlugin, SuperLog {
    nonisolated static let logger = Logger(subsystem: "com.coffic.lumi.plugin.llm-provider.feifeimiao", category: "Feifeimiao")
    ...
    public func onBoot(kernel: KernelCoreContainer) throws {
        ...
        let providers: [any SuperLLMProvider] = [FeifeimiaoProvider(networkProvider: networkProvider)]
