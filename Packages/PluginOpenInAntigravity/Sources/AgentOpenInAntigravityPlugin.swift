...
public final class AgentOpenInAntigravityPlugin: LumiPlugin {
    ...
    public func pluginAboutView(kernel: KernelLumi) -> AnyView? {
        AnyView(
            OpenInLandingPage(displayName: LumiPluginLocalization.string("Open in Antigravity", bundle: .module), icon: "globe", appDescription: LumiPluginLocalization.string("Open current project in Antigravity editor", bundle: .module))
        )
    }
