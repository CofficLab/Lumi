...
@MainActor
final class OpenInFinderToolbarViewModel: ObservableObject {
    let tool: OpenInTool
    ...
    func openProjectInFinder() {
        ...
        Task { @MainActor [weak self] in
            ...
            do {
                ...
                OpenInFinderPlugin.logger.error("\(OpenInFinderPlugin.t)Failed to open project in Finder: \(error.localizedDescription)")
            }
        }
    }
}
