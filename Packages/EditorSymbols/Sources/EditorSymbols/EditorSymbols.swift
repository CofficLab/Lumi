...
private final class EditorSymbolsBundleToken {}

private enum EditorSymbolsBundle {
    static var current: Bundle {
        let hostBundle = Bundle(for: EditorSymbolsBundleToken.self)
        ...
        let candidates = [
            ...
            "EditorSymbols_EditorSymbols.bundle",
...
public extension Image {
    ...
    init(symbol: String) {
        self.init(symbol, bundle: EditorSymbolsBundle.current)
    }
...
public extension NSImage {
    ...
    static func symbol(named: String) -> NSImage? {
        EditorSymbolsBundle.current.image(forResource: named)
    }
